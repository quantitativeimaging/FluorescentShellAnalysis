...
for lpIts = 1:numberIts
    I     = image_unifEl_Monte(b0, X);
    sumSq = sum((I - listI).^2);       % Quantifies misfit at initial guess

    % Check for sphere radius improvement
    IradHi = image_unifEl_Monte(b0 + [0,0,radR,0,0,0,0], X);
    IradLo = image_unifEl_Monte(b0 - [0,0,radR,0,0,0,0], X);
    ...
    I     = image_unifEl_Monte(b0, X);
    sumSq = sum((I - listI).^2);
    IvarHi = image_unifEl_Monte(b0 + [0,0,0,radVar,0,0,0], X);
    IvarLo = image_unifEl_Monte(b0 - [0,0,0,radVar,0,0,0], X);
    ...
    I     = image_unifEl_Monte(b0, X);
    sumSq = sum((I - listI).^2);
    IhtHi = image_unifEl_Monte(b0 + [0,0,0,0,radHt,0,0], X);
    IhtLo = image_unifEl_Monte(b0 - [0,0,0,0,radHt,0,0], X);
    ...
    I     = image_unifEl_Monte(b0, X);
    sumSq = sum((I - listI).^2);
    IxcHi = image_unifEl_Monte(b0 + [radX,0,0,0,0,0,0], X);
    IxcLo = image_unifEl_Monte(b0 - [radX,0,0,0,0,0,0], X);
    ...
    I     = image_unifEl_Monte(b0, X);
    sumSq = sum((I - listI).^2);
    IycHi = image_unifEl_Monte(b0 + [0,radY,0,0,0,0,0], X);
    IycLo = image_unifEl_Monte(b0 - [0,radY,0,0,0,0,0], X);
    ...
    I     = image_unifEl_Monte(b0, X);
    sumSq = sum((I - listI).^2);
    IazHi = image_unifEl_Monte(b0 + [0,0,0,0,0,0,radPsi], X);
    IazLo = image_unifEl_Monte(b0 - [0,0,0,0,0,0,radPsi], X);
    ...
    I     = image_unifEl_Monte(b0, X);
    sumSq = sum((I - listI).^2);
    IelHi = image_unifEl_Monte(b0 + [0,0,0,0,0,radEl,0], X);
    IelLo = image_unifEl_Monte(b0 - [0,0,0,0,0,radEl,0], X); % ( half)
